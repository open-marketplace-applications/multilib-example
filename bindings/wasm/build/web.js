...
const entryFilePath = path.join(__dirname, '../web/multilib_example_wasm.js')
...
const entryFilePathTs = path.join(__dirname, '../web/multilib_example_wasm.d.ts')
